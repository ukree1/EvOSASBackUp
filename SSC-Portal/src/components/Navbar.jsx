    ...
    <nav className="bg-white shadow sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 py-2 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-2 text-sm lg:text-base">
          ...
          <Link
            to="/announcements"
            className={`px-3 py-2 rounded-lg ${isActive("/announcements")}`}
          >
            Announcements
          </Link>
          ...
          <Link
            to="/evaluation"
            className={`px-3 py-2 rounded-lg ${isActive("/evaluation")}`}
          >
            Evaluation
          </Link>
  ...
  <div className="relative group">
    ...
    <div
      className="
        ...
        bg-white border rounded-lg shadow-md w-48
        opacity-0 invisible
